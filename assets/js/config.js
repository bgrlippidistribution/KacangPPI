...
export const CONFIG = {
    // Web App URL untuk fetch data dari spreadsheet
    WEBAPP_URL: 'https://script.google.com/macros/s/AKfycbzp6qgq4XXeRczycb3ttOmijJotXsVgP2DnGJZikcveZhutHree_9vVLpJ-VgsyMBTWRg/exec',
    ...
    // SLA per stage
    STAGE_SLA: ['8 Jam', '24 Jam', '4 Jam', '4 Jam', '4 Jam', '48 Jam', '48 Jam', '24 Jam', '24 Jam', '24 Jam', '24 Jam', '24 Jam'],
    
    // Detail per stage untuk popup
    STAGE_DETAILS: {
        'Pre-Alert & Verval': {
